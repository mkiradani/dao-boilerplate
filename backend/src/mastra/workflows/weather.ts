...
const fetchWeather = new Step({
  ...
  execute: async ({ context }): Promise<WeatherForecast[]> => {
...
const planActivities = new Step({
  ...
  execute: async ({ context, mastra }): Promise<ActivitiesResult> => {
    const forecast =
    ...
    // Collect the text chunks to build the complete response
    let fullText = '';
